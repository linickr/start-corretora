  ...
  <div class="container">
    <div style="max-width:560px;margin:0 auto">
      ...
      <form id="blogCotacaoForm" novalidate>
        ...
        <p class="form-note" style="text-align:center;margin-top:12px">Seus dados são confidenciais e não serão compartilhados.</p>
      </form>

      <div id="blogCotacaoOk" style="display:none;text-align:center;padding:40px 0">
        <div style="font-size:2.5rem;margin-bottom:12px">✅</div>
        <h3 style="color:#00e676;margin-bottom:8px">Solicitação enviada!</h3>
        <p style="color:#888">Nossa equipe vai entrar em contato pelo WhatsApp em breve.</p>
      </div>
...
<script>
document.getElementById('blogCotacaoForm').addEventListener('submit', function(e) {
  e.preventDefault();
  ...
  document.getElementById('blogCotacaoOk').style.display = 'block';
});
</script>`
